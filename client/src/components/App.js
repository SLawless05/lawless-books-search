...
export class App extends Component {
	...
	constructor(props) {
		...
		this.updateSaveHighlight = this.updateSaveHighlight.bind(this);
	...
	componentDidMount() {
		...
		if (!window.navigator.onLine) {
			setTimeout(function () { alert('You appear to be offline. Your saved are still avaiable to you'); }, 1);
			// Open IDB
		...
		return (
			<div className="app">
				...
				<Saved data={this.state.saved}
					highlight={this.updateSaveHighlight}
